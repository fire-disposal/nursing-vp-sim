...
| **Data** | hand-written | INSERT, UPDATE, seed data, `op.execute()`, sequence fix | `# Manual override reason: data_only` |

**Autogenerated files MUST NOT contain `op.execute()`.** Create a separate data migration instead.
