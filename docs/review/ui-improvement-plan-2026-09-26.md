...
| **弹窗宽度四档归一** | 全仓 14 种弹窗宽度（360…800 + `sm`/`md`）→ 四档：**420 / 560 / 680 / 800**（≤460→420、≤560→560、≤700→680、>700→800），只改 `<Modal>` 自身的尺寸属性 | 12 处归一（10 个文件）；`tsc` 干净；误伤图标 `size={18/20/48}` 的三处已回退（脚本已改为"行首即 size 属性"严格匹配） |
