...
export interface paths {
  ...
  "/api/admin/api/configs/{config_id}/reset": {
    ...
    put?: never;
    /** Reset Config */
    post: operations["reset_config_api_admin_api_configs__config_id__reset_post"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface operations {
  ...
  reset_config_api_admin_api_configs__config_id__reset_post: {
    parameters: {
      query?: never;
      header?: never;
      path: {
  ...
  list_rubrics_api_admin_api_rubrics_get: {
    ...
    responses: {
      ...
      200: {
        ...
        content: {
          "application/json": components["schemas"]["RubricBrief"][];
        };
      };
    };
  };
