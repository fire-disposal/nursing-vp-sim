export const queryKeys = {
  ...
  training: {
    ...
    detail: (id: number | string) => [...queryKeys.training.all, "detail", id] as const,
    review: (id: number | string) => [...queryKeys.training.all, "review", id] as const,
    state: (recordId: number) => [...queryKeys.training.all, "state", recordId] as const,
  },
  qa: {
    all: ["qa"] as const,
  ...
  questionnaires: {
    ...
    templates: (offset: number, typeFilter?: string) => [...queryKeys.questionnaires.all, "templates", offset, typeFilter] as const,
    detail: (id: number | null) => [...queryKeys.questionnaires.all, "detail", id] as const,
