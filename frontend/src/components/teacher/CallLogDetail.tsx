...
import { AlertCircle, Clock, Cpu, DollarSign, FileText, Hash, Zap } from "lucide-react";
          ...
          <>
            ...
            <div className="rounded-xl border border-border bg-card p-4 mb-4">
              ...
              <MetaRow
                icon={DollarSign}
                label="\u8d39\u7528"
                value={log.estimated_cost != null ? `\xA5${Number(log.estimated_cost).toFixed(6)} ${log.cost_currency || ""}`.trim() : "\u2014"}
              />
              <div className="flex items-center gap-2 text-sm py-1.5 border-b border-border/50 last:border-0">
              ...
              {log.error_message && <div className="mt-2 p-2 rounded bg-red-50 text-red-700 text-xs">{log.error_message}</div>}
            </div>
