...
import type { AssignForm, CaseBrief, ResponseStats, TemplateDetail, TemplateForm, TemplateListItem, ViewMode } from "@/components/teacher/questionnaires/types";
import { emptyForm } from "@/components/teacher/questionnaires/types";
import { useAssignTemplateMutation, useDeleteTemplateMutation, useSaveTemplateMutation } from "@/components/teacher/questionnaires/useQuestionnaireMutations";
...
export default function QuestionnairesTab() {
  ...
  if (view === "stats" && statsTemplate) {
    return <QuestionnaireStats template={statsTemplate} stats={stats} isLoading={isLoadingStats} onBack={backToList} />;
  }
