...
import type { PromptForm as PromptFormType, PromptTemplateResponse, PromptValidateResponse, VariableMeta } from "./types";
...
export default function PromptForm({
  ...
  const setField = (field: keyof PromptFormType, value: string) => onFormChange({ ...form, [field]: value });
    ...
    <div className="rounded-xl border border-border bg-card shadow-sm p-6 flex flex-col h-full">
      ...
      <div className="flex gap-2 flex-wrap">
        ...
        {editedPrompt && !editedPrompt.is_active && (
          <Button variant="outline" className="border-green-400 bg-green-50 text-green-700" onClick={() => onActivate(editedPrompt)}>
