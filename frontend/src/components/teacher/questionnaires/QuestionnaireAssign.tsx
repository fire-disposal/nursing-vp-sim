import type { AssignForm as AssignFormType, CaseBrief } from "@/components/teacher/questionnaires/types";
import { inputClass, TRIGGER_EVENT_OPTIONS } from "@/components/teacher/questionnaires/types";
...
export default function QuestionnaireAssign({
  ...
  return (
    <Modal open={open} onClose={onClose} title={`分配病例: ${templateTitle}`} maxWidth={600}>
        ...
        <div className="flex gap-3">
          <div className="flex-1">
            ...
            <select
              ...
              onChange={(e) => onAssignFormChange((f) => ({ ...f, trigger_event: e.target.value }))}
            ...
            <div className="flex items-center gap-2 pt-2">
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  onChange={(e) => onAssignFormChange((f) => ({ ...f, is_required: e.target.checked }))}
