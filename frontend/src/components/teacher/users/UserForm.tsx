...
export default function UserForm({
	...
	const [editForm, setEditForm] = useState<EditUserFormValues>({
		display_name: "",
		student_id: "",
		role: "",
		password: "",
				...
				<form onSubmit={handleEditSubmit}>
					...
					<div className="mb-4">
						...
						<select
							...
							onChange={(e) =>
								setEditForm((f) => ({ ...f, class_id: e.target.value }))
							}
							disabled={!editGrade}
						>
							<option value="">不指定</option>
			...
			>
				...
				<div className="flex-[1_1_120px]">
					...
					<input
						...
						onChange={(e) =>
							setRegForm({ ...regForm, display_name: e.target.value })
						}
						required
						className={inputClass}
					/>
				...
				<div className="flex-[1_1_100px]">
					...
					<input
						...
						onChange={(e) =>
							setRegForm({ ...regForm, student_id: e.target.value })
						}
						className={inputClass}
					/>
				</div>
				...
				<div className="flex-[1_1_120px]">
					...
					<select
						...
						onChange={(e) =>
							setRegForm({ ...regForm, class_id: e.target.value })
						}
						disabled={!regGrade}
						className={selectClass}
					>
