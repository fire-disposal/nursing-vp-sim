...
interface UserListProps {
  ...
  onClassFilterChange: (params: { grade_id: number | null; class_id: number | null }) => void;
  ...
  return (
    <div className="rounded-xl border border-border bg-card shadow-sm p-6">
      <div className="mb-3 flex gap-2 items-center">
        ...
        <select value={roleFilter} onChange={(e) => onRoleFilterChange(e.target.value)} className={filterSelectClass}>
        ...
        <span className="text-sm text-muted-foreground whitespace-nowrap">共 {total} 人</span>
      </div>
