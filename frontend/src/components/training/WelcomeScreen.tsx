    ...
    <div className="flex h-full items-center justify-center p-4">
      <div className="text-center space-y-6 max-w-sm w-full">
        <Card className="p-6 text-center space-y-4">
          <img className="w-20 h-20 rounded-full object-cover mx-auto bg-muted ring-4 ring-border" src={avatarSrc} alt={patient.name} />
          <div>
        ...
        <div className="text-center space-y-2">
          ...
          <button type="button" onClick={() => onQuickPrompt?.("您好，请问哪里不舒服？")} className="text-xs text-primary hover:underline">
            试试："您好，请问哪里不舒服？"
          </button>
        </div>
      </div>
