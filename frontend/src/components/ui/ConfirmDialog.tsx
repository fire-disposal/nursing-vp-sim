				...
				<AlertDialogContent className="max-w-[420px]">
					<AlertDialogHeader>
						<div className="flex items-start gap-3">
							...
							<button
								...
								className="flex shrink-0 cursor-pointer p-1 text-gray-400 hover:text-gray-600"
							>
								<X size={18} />
							</button>
						</div>
					...
					<AlertDialogFooter>
						...
						<AlertDialogAction
							...
							className={
								isDanger ? "bg-destructive hover:bg-destructive/90" : undefined
							}
						>
			...
			<AlertDialogContent className="max-w-[420px]">
				...
				<AlertDialogFooter>
					...
					<AlertDialogAction
						onClick={onConfirm}
						className={
							danger ? "bg-destructive hover:bg-destructive/90" : undefined
						}
					>
						{confirmLabel}
					</AlertDialogAction>
