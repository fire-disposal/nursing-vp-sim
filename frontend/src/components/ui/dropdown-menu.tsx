    ...
    <MenuPrimitive.Portal>
      <MenuPrimitive.Positioner className="isolate z-50 outline-none" align={align} alignOffset={alignOffset} side={side} sideOffset={sideOffset}>
        <MenuPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-(--available-height) w-(--anchor-width) min-w-32 origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-lg bg-popover p-1 text-popover-foreground shadow-md ring-1 ring-foreground/10 outline-none data-open:duration-200 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-open:data-[side=bottom]:slide-in-from-top-2 data-open:data-[side=left]:slide-in-from-right-2 data-open:data-[side=right]:slide-in-from-left-2 data-open:data-[side=top]:slide-in-from-bottom-2 data-closed:duration-100 data-closed:animate-out data-closed:overflow-hidden data-closed:fade-out-0",
            className,
          )}
          {...props}
        />
