      ...
      <div className="hub-status-bar">
        ...
        <div className="hub-status-item">
          <span
            ...
            style={{
              color: latestScore != null ? "var(--color-primary)" : "var(--text-tertiary)",
            }}
          >
                  ...
                  {records.slice(0, 5).map((r) => (
                    <tr key={r.id}>
                      ...
                      <td
                        style={{
                          fontWeight: 600,
                          color: r.score_total != null ? "var(--color-primary)" : "var(--text-tertiary)",
                        }}
                      >
            ...
            {latestCompleted ? (
              <>
                ...
                <div className="feedback-mini-score-row">
                  ...
                  <span className={`feedback-mini-tag ${(latestCompleted.score_total ?? 0) >= 70 ? "good" : "warn"}`}>
