  ...
  return (
    <Layout>
      ...
      <div className="hub-status-bar">
        ...
        <div className="hub-status-item">
          <span
            className="hub-status-value"
            style={{
              color:
                latestScore != null ? "var(--color-primary)" : "var(--text-tertiary)",
            }}
          >
      ...
      <div className="dashboard-grid">
        <div className="dashboard-main">
          <div className="training-hero">
            ...
            {!inProgressRecord && (
              <div className="hero-hint">约 20 分钟完成一次训练</div>
            )}
          </div>
                    ...
                    >
                      ...
                      <div className="case-pick-info">
                        <div className="case-pick-name">
                          {c.name}
                          <span
                            className={`difficulty-badge d-${d}`}
                            style={{ marginLeft: 8 }}
                          >
                            {"★".repeat(d)}
                            {"☆".repeat(3 - d)}
                ...
                <tbody>
                  {records.slice(0, 5).map((r) => (
                    <tr key={r.id}>
                      ...
                      <td>
                        <span
                          className={`badge ${r.status === "completed" ? "badge-success" : "badge-info"}`}
                        >
            ...
            {latestCompleted ? (
              <>
                <div className="feedback-mini-row">
                  <span className="feedback-mini-case">
                ...
                <div className="feedback-mini-score-row">
                  <span className="feedback-mini-big">
                    {latestCompleted.score_total}
                  </span>
                  <span className="feedback-mini-unit">分</span>
                  <span
                    className={`feedback-mini-tag ${(latestCompleted.score_total ?? 0) >= 70 ? "good" : "warn"}`}
                  >
                ...
                <div className="feedback-mini-list">
                  {(
                    latestCompleted as { score?: ScoreData }
                  ).score?.strengths?.slice(0, 1).map((s: string, i: number) => (
