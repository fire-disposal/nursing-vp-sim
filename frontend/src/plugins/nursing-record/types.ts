export type ItemType = "input" | "textarea" | "select" | "radio" | "checkbox_group" | "vital_sign";
...
export type RecordSheetItem = InputItem | TextareaItem | SelectItem | RadioItem | CheckboxGroupItem | VitalSignItem;
