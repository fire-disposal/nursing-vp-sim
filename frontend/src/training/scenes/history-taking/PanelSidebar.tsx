...
export function PanelSidebar({ ctx, features, panels }: PanelSidebarProps) {
    ...
    <>
      ...
      {activePanelId && activePanel && (
        <PanelOverlay
          ...
          onClose={closePanel}
        >
          <PanelErrorBoundary panelName={activePanel.label}>
