...
import { InitiativeTab } from "@/components/training/panels/initiative/InitiativeTab";
import { InquiryTab } from "@/components/training/panels/inquiry/InquiryTab";
import { NURSING_RECORD_SHEET_CONFIG } from "@/components/training/panels/nursing-record/config";
import { NursingRecordPanel } from "@/components/training/panels/nursing-record/NursingRecordPanel";
import { PatientInfoTab } from "@/components/training/panels/patient-info/PatientInfoTab";
import { ExamPanel } from "@/components/training/panels/physical-exam/ExamPanel";
import type { BadgeInfo, PanelContext, PanelTabProps } from "@/engine/types";
...
export const HISTORY_TAKING_PANELS: PanelConfig[] = [
...
export const PANELS = HISTORY_TAKING_PANELS;
