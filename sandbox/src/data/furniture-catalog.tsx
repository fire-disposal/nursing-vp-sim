...
export const FURNI: FurniDef[] = [
  { id: "bed", name: "病床", category: "bed", tags: ["床","病房","卧具"], icon: "\u{1F6CF}", thumb: "#8aaece",
    render: () => (<>
  ...
  { id: "patient", name: "患者 (chibi)", category: "character", tags: ["人","患者"], icon: "\u{1F9D1}", thumb: "#f0c8a0",
    render: () => (<>
  ...
  { id: "iv", name: "输液架", category: "equipment", tags: ["输液","仪器"], icon: "\u{1F489}", thumb: "#c8d0d8",
    render: () => (<>
  ...
  { id: "monitor", name: "监护仪", category: "equipment", tags: ["监测","仪器"], icon: "\u{1F5A5}", thumb: "#6a8aaa",
    render: () => (<>
  ...
  { id: "chair", name: "椅子", category: "furniture", tags: ["座位","家具"], icon: "\u{1FA91}", thumb: "#c8b8a0",
    render: () => (<>
  ...
  { id: "plant", name: "盆栽", category: "decor", tags: ["植物","装饰"], icon: "\u{1F33F}", thumb: "#7aaa6a",
    render: () => (<>
  ...
  { id: "cabinet", name: "储物柜", category: "furniture", tags: ["储物","家具"], icon: "\u{1F5C4}", thumb: "#b8a888",
    render: () => (<>
  ...
  { id: "bedside", name: "床头柜", category: "furniture", tags: ["储物","家具","床头"], icon: "\u{1FA91}", thumb: "#d4b898",
    render: () => (<>
