 ...
 *
 * No hardcoded furniture.  Pass a scene DSL via initialState or
 * the default demo scene is used.
 */
...
export default function Demo3D({ initialState }: SceneProps) {
  const scene = useMemo<SceneDSL>(() => {
